...
eventname = ARGS[1]
# path = "/data/guochang/chuandian2/dat/selectstation/201304200802479/result/"
path = joinpath("/data/guochang/chuandian2/dat/selectstation", eventname, "result")

plot_func(joinpath(path, "result_stage1.jld2"))
plot_func(joinpath(path, "result_stage2.jld2"))
plot_func(joinpath(path, "result_stage3.jld2"))
