...
!   write(*,*) 'detect_mesh_surfaces'
  ...
  write(*,*) 'write_info_for_interpolation'
  call write_info_for_interpolation()

!   write(*,*) 'finalize_simulation'
