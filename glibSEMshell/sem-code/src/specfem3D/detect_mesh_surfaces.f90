...
!=====================================================================
  ...
  if (MOVIE_VOLUME) then
    ...
    if (ELASTIC_SIMULATION .or. POROELASTIC_SIMULATION) then
      ...
      dvxdxl(:,:,:,:) = 0._CUSTOM_REAL
      dvxdyl(:,:,:,:) = 0._CUSTOM_REAL
      dvxdzl(:,:,:,:) = 0._CUSTOM_REAL
      dvydxl(:,:,:,:) = 0._CUSTOM_REAL
      dvydyl(:,:,:,:) = 0._CUSTOM_REAL
      dvydzl(:,:,:,:) = 0._CUSTOM_REAL
      dvzdxl(:,:,:,:) = 0._CUSTOM_REAL
      dvzdyl(:,:,:,:) = 0._CUSTOM_REAL
      dvzdzl(:,:,:,:) = 0._CUSTOM_REAL
    endif
  endif
