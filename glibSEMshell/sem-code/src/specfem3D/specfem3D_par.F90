...
!   real(kind=CUSTOM_REAL), dimension(:,:,:), allocatable :: displ_record,veloc_record,accel_record
  real(kind=CUSTOM_REAL), dimension(:,:), allocatable :: veloc_record
  integer, dimension(:), allocatable :: used_globid, used_specid
  integer :: NUsedGlob, NUsedSpec
...
! parameter module for movies/shakemovies
  ...
  real(kind=CUSTOM_REAL), dimension(:,:,:,:),allocatable:: dvxdxl,dvxdyl,dvxdzl,dvydxl, &
     dvydyl,dvydzl,dvzdxl,dvzdyl,dvzdzl
